    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between bg-slate-900 p-12 text-white">
        <div className="flex items-center gap-3">
          ...
          <span className="text-lg font-semibold tracking-tight">Clarbit</span>
        </div>

        <div className="space-y-6">
          <blockquote className="space-y-4">
            <p className="text-2xl font-medium leading-relaxed text-white/90">
              &ldquo;Clarbit replaced three tools overnight. Our entire team now works from one place &mdash; boards, automations, dashboards.&rdquo;
            </p>
            <footer className="space-y-1">
              <p className="text-sm font-semibold text-white">Sarah Chen</p>
              <p className="text-xs text-white/50">VP Operations &middot; Meridian Labs</p>
            </footer>
          </blockquote>
        </div>
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-12 lg:px-12">
        ...
        <div className="mb-10 flex items-center gap-2 lg:hidden">
          ...
          <span className="text-base font-semibold tracking-tight text-foreground">Clarbit</span>
        </div>

    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between bg-gradient-to-br from-neutral-950 via-stone-900 to-neutral-900 p-12 text-white">
        <div className="flex items-center gap-3">
          <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-blue-600 text-sm font-black tracking-tight">
            M
          </div>
      ...
      {/* Right panel — form */}
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-12 lg:px-12 bg-white dark:bg-stone-950">
        {/* Mobile logo */}

  ...
  return (
    <div className="flex flex-1 flex-col min-h-0 overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto px-6 py-6 space-y-8">
        <div className="flex items-center justify-between rounded-xl border border-amber-200 dark:border-amber-500/25 bg-amber-50 dark:bg-amber-500/5 backdrop-blur-md px-5 py-4">
          <div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          {PLANS.map((plan) => {
            ...
            return (
              ...
              >
                {plan.highlight && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-amber-600 px-3 py-0.5 text-[10px] font-bold uppercase tracking-widest text-white shadow-sm shadow-amber-500/30">
                    Your plan
                  </div>
                )}
                  ...
                  <div
                    className={cn(
                      ...
                      plan.highlight
                        ...
                        : 'bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 text-slate-500 dark:text-zinc-400',
                    )}
                  >

...
> = {
  ...
  DEFENDER_O365: {
    ...
    defaultHost: 'https://graph.microsoft.com',
  },
  CROWDSTRIKE: {
    ...
    defaultHost: 'https://api.crowdstrike.com',
  },
  CORTEX_XDR: {
    ...
    bg: 'bg-orange-50 dark:bg-orange-500/10 border-orange-200 dark:border-orange-500/20',
    fields: [
      { key: 'apiKeyId', label: 'API Key ID', required: true, placeholder: '1' },
      {
        key: 'apiKey',
        label: 'API Key',
        required: true,
      ...
      { key: 'tenantId', label: 'Tenant FQDN prefix', required: true, placeholder: 'mytenant' },
    ],
    defaultHost: 'https://api.xdr.us.paloaltonetworks.com',
  },
  SERVICENOW: {
    label: 'ServiceNow',
    color: 'text-emerald-700 dark:text-emerald-400',
    ...
    defaultHost: 'https://instance.service-now.com',
  },
  JIRA: {
    ...
    bg: 'bg-blue-50 dark:bg-blue-500/10 border-blue-200 dark:border-blue-500/20',
    fields: [
      { key: 'email', label: 'Account Email', required: true, placeholder: 'you@company.com' },
      {
        key: 'apiToken',
        label: 'API Token',
        required: true,
      ...
      { key: 'projectKey', label: 'Default Project Key (optional)', placeholder: 'SOC' },
    ],
    defaultHost: 'https://yourcompany.atlassian.net',
  },
  CUSTOM: {

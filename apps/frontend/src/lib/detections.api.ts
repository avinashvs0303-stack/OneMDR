...
export const PLATFORM_COLORS: Record<DetectionPlatform, string> = {
  ...
  DEFENDER_O365: 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900/30 dark:text-cyan-400',
  CROWDSTRIKE: 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400',
  CORTEX_XDR: 'bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400',
  SERVICENOW: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400',
